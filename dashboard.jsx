  ...
  return (
    <div>
      ...
      <Card style={{marginBottom:14}}>
        ...
        <div style={{fontSize:12,color:C.t2,marginBottom:4}}>How many days does your period usually last? Currently set to <strong>{avgPeriodLen} days</strong>.</div>
        <div style={{fontSize:11,color:C.t3,marginBottom:10}}>Count the days you have any flow, even light.</div>
        <div style={{display:"flex",gap:8,alignItems:"center"}}>
          <input type="number" min="2" max="10" value={periodLenInput} onChange={e=>setPeriodLenInput(e.target.value)} placeholder={String(avgPeriodLen)} style={{...s.input,width:80}}/>
