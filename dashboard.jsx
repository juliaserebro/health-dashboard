...
const TAG_STYLE={pain:[C.rl,C.red],medical:[C.sll,C.sl],feedback:[C.tl,C.teal],postworkout:[C.orl,C.or],mood:[C.al,C.am],life:[C.pl,C.pu],sleep:[C.sll,C.sl],correction:[C.pil,C.pi],spine:[C.sll,C.slm]};
